...
rule pdfReportCunks:
	...
	input:
		...
		chunk_stats_by_maf_by_info=expand(output_folder+"/07.stats/{chr}/CHUNKS/{chr}_{g_chunk}_impute_summary_by_maf_by_info.csv",chr=lambda wildcards: wildcards.chr,g_chunk=glob_wildcards(os.path.join(output_folder+"/06.imputed/{chr}/", "{chr1}.{g_chunk}.vcf.gz")).g_chunk),
		chunk_stats_by_maf=expand(output_folder+"/07.stats/{chr}/CHUNKS/{chr}_{g_chunk}_impute_summary_by_maf.csv",chr=lambda wildcards: wildcards.chr,g_chunk=glob_wildcards(os.path.join(output_folder+"/06.imputed/{chr}/", "{chr1}.{g_chunk}.vcf.gz")).g_chunk),
		info_af=expand(output_folder+"/07.stats/{chr}/CHUNKS/{chr}_{g_chunk}_impute_summary.png",chr=lambda wildcards: wildcards.chr,g_chunk=glob_wildcards(os.path.join(output_folder+"/06.imputed/{chr}/", "{chr1}.{g_chunk}.vcf.gz")).g_chunk),
		manhattan=expand(output_folder+"/07.stats/{chr}/CHUNKS/{chr}_{g_chunk}_impute_manhattan.png",chr=lambda wildcards: wildcards.chr,g_chunk=glob_wildcards(os.path.join(output_folder+"/06.imputed/{chr}/", "{chr1}.{g_chunk}.vcf.gz")).g_chunk)
	params:
