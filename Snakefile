...
rule all:
    ...
    input:
        ...
        expand(output_folder + "/03.flipped_input/" + ref_panel + "/"+ cohort_name+"_{chr}_flipped.vcf.gz", chr=chrs),
        expand(output_folder + "/03.flipped_input/" + ref_panel + "/"+ cohort_name+"_{chr}_flipped.vcf.gz.tbi", chr=chrs)
