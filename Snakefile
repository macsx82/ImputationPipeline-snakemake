...
rule all:
    ...
    input:
        ...
        #generate main imputation results and file conversion
        ...
        expand(output_folder+"/06.imputed/R2/{chr}/{chr}.{ext}", ext=["vcf.gz","vcf.gz.csi","vcf.gz.tbi"],chr=chrs),
        #generate stats
        expand(output_folder+"/07.stats/{chr}/{chr}.info_stats.gz",chr=chrs),
        ...
        expand(output_folder+"/07.stats/{chr}/{chr}_impute_summary_report.pdf",chr=chrs),
        ...
        release_folder+"/08.release/03.IMPUTED/VCF",
        release_folder+"/08.release/03.IMPUTED/BIMBAM",
